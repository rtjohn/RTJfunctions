function [outImg] = mrAnatAverageAcpcMIND(fileNameList, outFileName, alignLandmarks, newMmPerVox, weights, bb, showFigs, clipVals)
%
% outImg = mrAnatAverageAcpcMIND(fileNameList, outFileName, [alignLandmarks=[]], [newMmPerVox=[1 1 1]], [weights=ones(size(fileNameList))], [bb=[-90,90; -126,90; -72,108]'], [showFigs=true], [clipVals])
%
...
% 2011.06.15 RTJ just made it so the default is to not show figs
